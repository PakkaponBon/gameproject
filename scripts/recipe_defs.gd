...
const ORDER := ["forge_sword", "forge_warhammer", "forge_spear", "forge_club",
		"craft_bow", "craft_arrows", "forge_mail", "smelt_iron",
...
const DEFS := {
	...
	"forge_spear": {
		"name": "Forge Spear",
		"station": "forge",
		"inputs": {"iron_ingot": 1, "wood": 2},  # iron-light option
		"output": "spear",
		"craft_ticks": 45,
		"max_stock": 2,
	},
