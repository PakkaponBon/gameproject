...
const DEFS := {
	...
	"club": {"name": "Club", "color": Color(0.6, 0.45, 0.3), "sprite": 7},
	"spear": {"name": "Spear", "color": Color(0.72, 0.72, 0.62), "sprite": 7},
	"warhammer": {"name": "Warhammer", "color": Color(0.5, 0.5, 0.56), "sprite": 7},
